...
export const Dart: React.FC<IconProps> = ({
  ...
  >
    <path
      fill={colorless? COLORLESS_PRIMARY_COLOR : "#1565c0"}
      d="M10,12l3,25l-8.019-8.019c-1.189-1.189-1.508-2.996-0.796-4.52L10,12z"
    />
    <path
      fill={colorless? COLORLESS_PRIMARY_COLOR : "#42a5f5"}
    ...
    />
    <polygon fill={colorless? COLORLESS_PRIMARY_COLOR : "#85cbf8"} points="35,37 13,37 19,43 35,43" />
  </svg>
)
