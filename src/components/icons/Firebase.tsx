...
export const Firebase: React.FC<IconProps> = ({
  size,
  fill = 'none',
  stroke,
  className,
  ...
  >
    ...
    <path
      ...
      fill={colorless ? COLORLESS_PRIMARY_COLOR : '#eeab37'}
    />
  </svg>
)
