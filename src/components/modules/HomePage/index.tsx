    ...
    return (
        <div className="w-full py-20 px-16 flex flex-col gap-24">
            <div className="flex flex-col gap-8">
                <h3 className="text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#D1D505] to-[#F60202]">{`Hey there! `}
            ...
            <div className="flex flex-col gap-8">
                <h2 className="text-6xl font-bold text-white">{`Languages-Frameworks-Tools `}
                    <span>⚒️</span>
                </h2>
