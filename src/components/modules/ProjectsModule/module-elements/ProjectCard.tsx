...
export const ProjectCard = ({
  ...
  <article className="flex flex-col h-full bg-gradient-to-b from-[#210A0A] to-[#6B1D1D] rounded-lg shadow-lg overflow-hidden">
    <div className="relative w-full aspect-[500/225]">
      <Image
    ...
    <div className="flex flex-col flex-1 gap-4 md:gap-5 p-5 md:p-6">
        ...
        <div className="mt-auto flex flex-wrap items-center gap-3 md:gap-4">
          ...
          {documentation && (
            <Link
              ...
              className={`rounded-lg px-1 py-2 font-semibold text-white underline text-sm md:text-base hover:text-[#FFDE24] ${FOCUS}`}
            >
              Documentation
            </Link>
          )}
