...
export const Navbar = () => {
    ...
    return (
        <nav className="fixed z-50 w-full flex flex-col md:items-center justify-center shadow-lg bg-[#0B1726]">
            ...
            <div className={`flex-col items-start gap-4 py-4 px-4 md:hidden ${isCollapsed? 'hidden' : 'flex'}`}>
                {MENUS.map(({label, url}) => (
                    <NavLink
                        label={label}
                        url={url}
